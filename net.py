...
class gtnet(nn.Module):
    def __init__(self, train_feas, gcn_true, buildA_true, gcn_depth, num_nodes, device, predefined_A=None, static_feat=None, dropout=0.3, subgraph_size=20, node_dim=40, dilation_exponential=1, conv_channels=32, residual_channels=32, skip_channels=64, end_channels=128, seq_length=12, in_dim=2, out_dim=12, layers=3, propalpha=0.05, tanhalpha=3, layer_norm_affline=True):
        ...
        self.Adjacency_generator = Adjacency_generator(embedding_size=256, num_nodes=num_nodes,
                                                       ...
                                                       kernel_size=12, freq=288,
                                                       requires_graph=2,
                                                       seq_len=seq_length, input_dim=1,
                                                       device=device)
